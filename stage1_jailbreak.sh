...
start_palera1n -f -c
prompt "Watch the palera1n output. When it says 'Press Enter when ready for DFU mode', press Enter here — then follow its countdown and hold Power+Home on the iPhone."
palera1n_enter
wait_for_pongoos_and_stop
